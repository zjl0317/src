...
#ifndef ROBOT305_KINEMATICS_DYNAMICS_H_
#define ROBOT305_KINEMATICS_DYNAMICS_H_

#include <vector>
#include <eigen3/Eigen/Eigen>

#include "robot305_kinematics_dynamics_define.h"
#include "link_data.h"
...
class ROBOT305KinematicsDynamics
{

 public:
  ROBOT305KinematicsDynamics();
  ~ROBOT305KinematicsDynamics();
  ROBOT305KinematicsDynamics(TreeSelect tree);
  ...
  LinkData *robot305_link_data_[ ALL_JOINT_ID + 1];
  ...
  double waist_length_m_;
};

}

#endif /* ROBOT305_KINEMATICS_DYNAMICS_H_ */
