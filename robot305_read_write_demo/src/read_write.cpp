...
int main(int argc, char **argv)
{
  ...
  // wait for starting of robot305_manager
  std::string manager_name = "/robot305_manager";
  while (ros::ok())
  {
    ...
    ROS_WARN("Waiting for robot305 manager");
  }
...
bool checkManagerRunning(std::string& manager_name)
{
  ...
  ROS_ERROR("Can't find robot305_manager");
  return false;
}
